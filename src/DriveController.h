...
public:
	...
	void StopAll();
	void StartTeleopThreads(Joystick *JoyThrottle, Joystick *JoyWheel, bool *is_kick);
	void StartAutonThreads();
	void EndThreads();
	void Drive(double ref_kick, double ref_right, double ref_left, double k_p_right, double k_p_left, double k_p_kick);
